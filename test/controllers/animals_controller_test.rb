...
class AnimalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create animal" do
    assert_difference('Animal.count') do
      post animals_url, params: { animal: { animal_type_id: @animal.animal_type_id, nombre: @animal.nombre } }
    end
  ...
  test "should update animal" do
    patch animal_url(@animal), params: { animal: { animal_type_id: @animal.animal_type_id, nombre: @animal.nombre } }
